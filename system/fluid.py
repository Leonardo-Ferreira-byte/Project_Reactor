...
from correlations.solubility import get_viscosity, get_diffusion_oil, get_diffusion_H2, get_diffusion_H2S, get_Henry_H2, get_Henry_H2S
from correlations.mass_transfer import kiL_aL_fun, kiS_aS_fun

class Fluid:

    def __init__(self, T =653.15 , P = 5.3, fi = 356, LHSV=2, API = 22, Mm1 = 441.9, T_MeABP = (476 + 273.15)*1.8, rhob = 0.8163, heterogeneous  = False):
